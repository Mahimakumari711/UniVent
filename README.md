...
Each club is presented through an interactive card containing:
...
Club information cards with images and descriptions
...
Login Modal
Council login popup interface
Username and password fields
Remember Me option
Modal open/close functionality using JavaScript
🛠️ Technologies Used
HTML5
CSS3
